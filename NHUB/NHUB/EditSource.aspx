...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="RenameTextBox" ErrorMessage="Please enter alphabets only"></asp:RegularExpressionValidator>
    </p>
    <p>
        &nbsp;</p>
    <p>
